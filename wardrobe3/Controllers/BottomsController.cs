...
namespace wardrobe3.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Photo,Name,Type,Color,Season,Occasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Photo,Name,Type,Color,Season,Occasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
